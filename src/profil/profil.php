...
$sql = "SELECT user_id, prenom, nom,email, password  FROM users";
                                                    ...
                                                    <div class="row m-l-0 m-r-0">
                                                        <div class="col-sm-4 bg-c-lite-green user-profile">
                                                            <div class="card-block text-center text-white">
                                                                ...
                                                                <h6 class="f-w-600">Vos Informations</h6>
                                                            ...
                                                            <div class="card-block">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <h6 class="text-muted f-w-400"><?php echo htmlspecialchars($user['nom']); ?></h6>
                                                                    </div>
                                                                </div>
